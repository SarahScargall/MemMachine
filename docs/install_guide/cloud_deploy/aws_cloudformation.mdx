...
6. **Determine `STACK_NAME`** 
    - you will need to use the same name for this parameter throughout deployment.  
    - You can call the file whatever you like.  In this example, we are using `memmachine-ec2-stack`.  If you choose to use a different name, make sure any reference to `memmachine-ec2-stack` is replaced by your chosen stack name.

7. Cloud Formation Template - *see code block below*
...
aws configure
    STACK_NAME="memmachine-ec2-stack" 
    REGION="us-east-1" 
...
aws cloudformation create-stack \
    ...
    --template-body file://memmachine-ec2-cft.yaml \
...
<Tab title="Method2: AWS Console GUI">
