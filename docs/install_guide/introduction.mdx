...
<Card title="CrewAI" icon="people-group" href="/install_guide/integrate/crewai">
  **Empower Agent Squads with Long-Term Recall.** A complete guide to equipping your CrewAI agents with persistent memory. Enable cross-agent knowledge sharing, user preference tracking, and context retention across complex multi-task workflows.
<Card title="Google ADK" icon="google" href="/install_guide/integrate/Google_ADK">
  **Extend Google GenAI with Long-Term Memory.** A guide to integrating MemMachine as a `BaseMemoryService` for Google ADK. Automatically archive sessions and empower Gemini agents to recall past user interactions through the standard `load_memory` tool.
</Card>
<Card title="Dify" icon="puzzle-piece" href="/install_guide/integrate/dify">
  **Build State-of-the-Art LLM Apps with Dify.** A quick-start guide to adding MemMachine as a **Custom Tool Provider** in Dify, enabling your agents with robust long-term memory, conversation history, and user context.
</Card>
</Columns>
