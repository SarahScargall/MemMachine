---
title: "Klavis (Strata) Integration Guide"
description: "Setting up MemMachine with Klavis (Strata) HTTP Integration"
icon: "water"
---

Hello there! This guide is designed to walk you through the process of connecting your **MemMachine MCP server** to **Strata** (Klavis’ Multi-Component Protocol or MCP router) using a standard **HTTP (StreamableHTTP)** connection.
