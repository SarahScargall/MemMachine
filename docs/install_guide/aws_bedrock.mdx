...
<Note> Within the 'cfg.yml' file, make sure duplicate models are removed.  IE, if you are using the aws_model, ensure that any other model configurations (like openai_model) are deleted to avoid conflicts. </Note>
