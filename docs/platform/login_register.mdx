...
description: 'The MemMachine Playground User Guide - Login and Registration'
icon: 'right-to-bracket'
---

Welcome to the **MemMachine Playground User Guide**! This page provides step-by-step instructions on how to **register** for a new account and **log in** to the MemMachine Playground.

### Accessing the Playground

Navigate to the MemMachine Playground URL (e.g., `https://console.memmachine.ai`) in your web browser. You will be presented with the primary **Login** screen:
...
After completing the required fields, click the blue **Register** button to finalize your registration. You will then be automatically directed to the **MemMachine Playground Console**.
</Step>
</Steps>
</Tab>
...
You will be redirected to a GitHub Authorization page. This page requests authorization to link the MemMachine playground with your GitHub account.
...
Once you have completed the form, click the **Submit** button. Registration will be complete, and you will be directed to the **MemMachine playground Console**.
</Step>
</Steps>
</Tab>
...
Choose the Google Account you wish to use for logging into the MemMachine playground.
...
You will be redirected back to the MemMachine playground to the **Account Update Form**. This step verifies your account information and completes the registration process.
