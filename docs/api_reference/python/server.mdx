...
<CardGroup cols={2}>
  <Card title="Memory Types" icon="cube" href="/server/memory_types">
    The atomic building blocks and Enums used by the server.
  </Card>
  <Card title="Episodic Memory" icon="brain" href="/server/episodic_memory">
    Deep dive into session management and search logic.
  </Card>
  <Card title="Semantic Memory" icon="diagram-project" href="/server/semantic_memory">
    Understanding the knowledge graph and tag management.
  </Card>
  <Card title="Memory Manager" icon="sitemap" href="/server/episodic_memory_manager">
