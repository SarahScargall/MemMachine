...
* `short_term_memory`: Recent interactions as [`EpisodicMemory[]`](./MemoryStructures).
* `long_term_memory`: Historical data as [`EpisodicMemory[]`](./MemoryStructures).
* `episode_summary`: A list of strings summarizing the found episodes.

**Semantic Memory (`content.semantic_memory`)**
* Returns an array of [`SemanticMemory[]`](./MemoryStructures) representing distilled knowledge.
